...
import { View, Text, TouchableOpacity, ScrollView, ImageBackground, Alert, ActivityIndicator, Image } from 'react-native';
    ...
    <View style={{ flex: 1, backgroundColor: PRIMARY_NAVY }}>
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} bounces={false}>
        ...
        <View className="h-64 w-full relative">
          ...
          <TouchableOpacity 
            onPress={() => router.back()}
            className="absolute top-12 right-6 w-8 h-8 rounded-full items-center justify-center z-10"
