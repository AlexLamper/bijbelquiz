    ...
    <div className={`flex w-full gap-3 sm:w-auto sm:gap-4 ${compactOnMobile ? 'flex-row' : 'flex-col sm:flex-row'}`}>
      <button 
        ...
        className={`flex h-14 items-center justify-center gap-3 rounded-2xl bg-[#1d1d1f] text-white transition-colors hover:bg-black dark:border dark:border-zinc-700 dark:bg-[#16181d] ${
          compactOnMobile ? 'min-w-0 flex-1 px-3 sm:min-w-40 sm:px-6' : 'min-w-40 px-6'
        }`}
      >
        ...
        <div className="text-left flex flex-col leading-tight">
          ...
          <span className={`${compactOnMobile ? 'text-[15px] sm:text-[17px]' : 'text-[17px]'} font-semibold tracking-wide`}>Google Play</span>
        </div>
      </button>
      ...
      >
        ...
        <div className="text-left flex flex-col leading-tight">
          ...
          <span className={`${compactOnMobile ? 'text-[15px] sm:text-[17px]' : 'text-[17px]'} font-semibold tracking-wide`}>App Store</span>
        </div>
      </button>
    </div>
  );
