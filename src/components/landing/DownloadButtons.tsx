  ...
  return (
    <div className="flex w-full flex-col gap-4 sm:w-auto sm:flex-row">
      <button 
        ...
        className="flex h-14 min-w-40 items-center justify-center gap-3 rounded-2xl bg-[#1d1d1f] px-6 text-white transition-colors hover:bg-black"
      >
      ...
      <button 
        disabled
        className="flex h-14 min-w-40 cursor-not-allowed items-center justify-center gap-3 rounded-2xl bg-gray-500 px-6 text-gray-200 opacity-80"
      >
