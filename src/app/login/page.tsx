    ...
    <div className="flex min-h-[70vh] items-center justify-center py-12">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl font-bold">Inloggen</CardTitle>
          <CardDescription>
            Log in op je BijbelQuiz account.
          </CardDescription>
        </CardHeader>
        <CardContent className="grid gap-4">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-2 text-slate-500">Of ga verder met</span>
            </div>
          </div>
        ...
        <CardFooter className="flex flex-col gap-4 text-center text-sm text-slate-500">
          <p>
            Nog geen account?{' '}
            <Link href={`/register?callbackUrl=${encodeURIComponent(callbackUrl)}`} className="text-primary hover:underline font-semibold">
              Registreren
            </Link>
          </p>
        </CardFooter>
