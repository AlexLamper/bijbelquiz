        ...
        <div className="grid gap-4 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)]">
          <Card className="border-rule bg-paper-raised/80 py-0">
            <CardContent className="p-6">
              <div className="mb-3 inline-flex h-11 w-11 items-center justify-center rounded-full bg-vermilion-tint">
                <Trash2 className="h-5 w-5 text-vermilion" />
              </div>
              <h2 className="text-2xl text-ink">Verwijderen via e-mail</h2>
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                <Button asChild className="bg-ink text-ink-inverted hover:bg-ink-soft">
                  <a href={mailtoHref}>
                    <Mail className="mr-2 h-4 w-4" />
                    Open e-mail app
                  </a>
                </Button>
                <Button asChild variant="outline" className="border-rule text-ink hover:bg-paper-sunken">
          ...
          <Card className="border-rule bg-paper-raised/80 py-0">
            <CardContent className="p-6">
              ...
              <h2 className="text-2xl text-ink">Sneller via de app</h2>
              <p className="mt-2 text-sm text-muted-foreground">
      ...
      <section className="mx-auto max-w-[1180px] px-4 pt-8 sm:px-5 lg:px-4">
        <Card className="border-rule bg-paper-raised/80 py-0">
          <CardContent className="space-y-6 p-6">
            <div>
              <h3 className="text-xl text-ink">Wat verwijderen we?</h3>
            ...
            <div>
              <h3 className="text-xl text-ink">Wat bewaren we wettelijk?</h3>
            ...
            <div className="rounded-md border border-vermilion/35 bg-vermilion-tint p-3 text-sm text-vermilion">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              <Link href="/privacybeleid" className="font-medium text-ink hover:underline">
                privacybeleid
              </Link>
              .
            </p>
